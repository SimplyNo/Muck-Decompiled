...
public class CaveSpawner : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    foreach (CaveSpawner.WeightedSpawn structurePrefab in this.structurePrefabs)
  ...
  public virtual void Process(GameObject newStructure, RaycastHit hit)
  {
    ...
    component.transform.rotation = Quaternion.Euler(-90f, (float) (this.randomGen.Next() * 360), 0.0f);
  ...
  public GameObject FindObjectToSpawn(
    CaveSpawner.WeightedSpawn[] structurePrefabs,
    float totalWeight)
  {
