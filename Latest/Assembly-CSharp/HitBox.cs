...
public class HitBox : MonoBehaviour
{
  ...
  public void UseHitbox()
  {
    if ((UnityEngine.Object) Hotbar.Instance.currentItem == (UnityEngine.Object) null)
      return;
    RaycastHit[] array = Physics.SphereCastAll(this.playerCam.position + this.playerCam.forward * 0.1f, 3f, this.playerCam.forward, 1.2f, (int) this.whatIsHittable);
    ...
    foreach (RaycastHit raycastHit in array)
    {
      ...
      if (!((UnityEngine.Object) component == (UnityEngine.Object) null) && (collider.gameObject.layer != LayerMask.NameToLayer("Player") || component.GetId() != LocalClient.instance.myId))
      {
        ...
        component.Hit(damage, sharpness, (int) hitEffect, raycastHit.collider.ClosestPoint(PlayerMovement.Instance.playerCam.position));
        num2 *= 0.5f;
