...
public class HitBox : MonoBehaviour
{
  ...
  public void UseHitbox()
  {
    ...
    if ((UnityEngine.Object) Hotbar.Instance.currentItem == (UnityEngine.Object) null)
      return;
    RaycastHit[] array = Physics.SphereCastAll(this.playerCam.position + this.playerCam.forward * 0.1f, 3f, this.playerCam.forward, 1.2f + PlayerStatus.Instance.currentChunkArmorMultiplier, (int) this.whatIsHittable);
    ...
    foreach (RaycastHit raycastHit in array)
    {
      ...
      if (!((UnityEngine.Object) component1 == (UnityEngine.Object) null) && (collider.gameObject.layer != LayerMask.NameToLayer("Player") || component1.GetId() != LocalClient.instance.myId))
      {
        ...
        if (!this.alreadyHit.Contains(component1))
        {
          ...
          component1.Hit(damage, sharpness, (int) hitEffect, raycastHit.collider.ClosestPoint(PlayerMovement.Instance.playerCam.position));
          num2 *= 0.5f;
