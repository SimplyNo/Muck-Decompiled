...
public class MobServerDragon : MobServer
{
  ...
  {
    if ((double) Vector3.Angle((VectorExtensions.XZVector(Boat.Instance.transform.position) - VectorExtensions.XZVector(this.transform.position)).normalized, this.mob.transform.forward) > 70.0)
      return;
